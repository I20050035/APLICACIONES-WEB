...
<html>
    ...
    <body>
        ...
        $consulta= ("SELECT * from datospersona");
        $datos = $conn->query($consulta);
        echo "<table class ='table table-striped table-light'>";
        echo "
        <th scope=col>iddatosPersona</th>
        ...
        {
            echo "<tr>";
            echo "<td class='table-secondary'>".$registro["iddatosPersona"]."</td>";
            ...
            echo "<td class='table-secondary'>".$registro["nss"]."</td>";
            echo "<td class='table-secondary'>".$registro["curp"]."</td>";
